...
ALTER TABLE TRIPULACAO CHANGE NOMKE_GUERRA NOME_GUERRA VARCHAR(45) NOT NULL;
RENAME TABLE STATUS TO STATUS_MISSAO;

ALTER TABLE AERONAVE
DROP FOREIGN KEY FK_AERONAVE_STATUS;

ALTER TABLE AERONAVE
ADD CONSTRAINT FK_AERONAVE_STATUS
FOREIGN KEY (ID_STATUS) REFERENCES STATUS_MISSAO(ID_STATUS);
